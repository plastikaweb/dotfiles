...
curl -L "https://github.com/docker/compose/releases/download/1.23.1/docker-compose-$(uname -s)-$(uname -m)" -o ${APPLICATIONS_PATH}/docker-compose/docker-compose
...
curl -L https://raw.githubusercontent.com/docker/compose/1.23.1/contrib/completion/zsh/_docker-compose > ${DOTFILES_PATH}/zsh/completion.d/_docker-compose
